...
public class CreateCostumerTest extends SharedData {
     //data-driven testing = concept pe baza caruia datele de test se vor salva in
    // fissiere externe cu scopul de ale accesa in orice test avem nevoie+ de a le accesa
    // in orice test avem nevoie+ sa le putem refolosi pentru acest concept
    // se accepta diferite extensii de fisiere
